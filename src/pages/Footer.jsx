const navigation = {
  ...
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/julian-russmeyer/',
      icon: (props) => (
        ...
        {
      name: 'GitHub',
      href: 'https://github.com/Julianrussmeyer/not-so-lucky-client',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/watch?v=PJQVlVHsFF8&list=FLPDJkEcq15_OWQrBzp6bUiw&index=14',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
